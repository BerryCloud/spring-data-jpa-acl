...
public class JacksonMappingAwarePropertySortTranslator {

    private final Repositories repositories;
    private final DomainPropertyClassResolver domainClassResolver;
    private final SortTranslator sortTranslator;

    /**
     * Creates a new {@link JacksonMappingAwarePropertySortTranslator} for the given {@link ObjectMapper},
     * {@link Repositories}, {@link DomainPropertyClassResolver} and {@link PersistentEntities}.
     * 
     * @param objectMapper
     *            must not be {@literal null}.
     * @param repositories
     *            must not be {@literal null}.
     * @param domainClassResolver
     *            must not be {@literal null}.
    ...
    public JacksonMappingAwarePropertySortTranslator(ObjectMapper objectMapper, Repositories repositories,
            DomainPropertyClassResolver domainClassResolver, PersistentEntities persistentEntities,
     ...
     * @param webRequest
     *            must not be {@literal null}.
     * @return a {@link Sort} containing translated property names or {@literal null} the resulting {@link Sort}
    ...
    public static class SortTranslator {
        ...
        /**
         * Translates {@link Sort} orders from Jackson-mapped field names to {@link PersistentProperty} names.
         * Properties that cannot be resolved are dropped.
         *
         * @param input
         *            must not be {@literal null}.
         * @param rootEntity
        ...
        private List<String> mapPropertyPath(PersistentEntity<?, ?> rootEntity, List<String> iteratorSource) {
            ...
            for (String field : iteratorSource) {
                ...
                List<? extends PersistentProperty<?>> persistentProperties = typedSegment
    ...
    static class TypedSegment {
         ...
         *            must not be {@literal null}.
         * @param rootEntity
         *            the initial entity to start mapping from, must not be {@literal null}.
         * @return
         */
